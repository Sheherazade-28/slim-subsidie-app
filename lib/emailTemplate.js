...
<title>Bevestiging SLIM Reservering</title>
</head>
    ...
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
      ...
      <tr>
        <td style="background:#0d2e5a;border-radius:10px 10px 0 0;padding:32px 40px;text-align:center;">
          ...
          <div style="font-size:14px;color:rgba(255,255,255,0.55);">Uw SLIM Reservering is betaald en actief</div>
        </td>
      </tr>
      ...
      <tr>
        <td style="background:#ffffff;padding:40px;">
          ...
          <p style="font-size:14px;color:#5a6e82;line-height:1.7;margin:0 0 24px;">
            Bedankt voor uw betaling. Uw SLIM Reservering is bevestigd${bedrijf ? ` voor <strong style="color:#1a2a3a;">${bedrijf}</strong>` : ""}.
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f7f9fc;border-radius:8px;border:1px solid #e8edf3;margin-bottom:28px;">
            <tr><td style="padding:20px 24px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr><td style="font-size:13px;color:#5a6e82;padding:5px 0;">Product</td><td style="font-size:13px;font-weight:600;color:#0d2e5a;text-align:right;">SLIM Reservering</td></tr>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#e6f5ee;border:1px solid #a8d8bc;border-radius:8px;margin-bottom:28px;">
            <tr><td style="padding:16px 20px;">
              ...
              <div style="font-size:12px;color:#1a7a4a;margin-top:2px;">60% van uw investering · tot €25.000</div>
            </td></tr>
          </table>` : ""}
          ...
          <div style="margin-bottom:28px;">
            ...
            ${[
              ...
              ["4","Succesfee bij toekenning","€ 2.500 excl. btw — alleen bij toekenning. Reserveringsfee wordt terugbetaald."],
            ].map(([nr, titel, tekst]) => `
