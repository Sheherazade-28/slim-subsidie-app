...
<table style="margin-bottom:8px;">
  ...
  <tbody>
    <tr>
      <td>
        <strong>SLIM Dieptecheck${earlyBird ? " — Early Bird" : ""}</strong>
        ${earlyBird ? `<br><span class="badge">20% Early Bird korting</span>` : ""}
        <br><span style="font-size:12px;color:#5a6e82;margin-top:4px;display:block;">Persoonlijke AI-diepteanalyse, aanvraagbegeleiding en screeningstraject bij RVO</span>
      </td>
